        ...
        child: Column(
          children: [
            ...
            GetBuilder<CarouselImageController>(
              builder: (controller) {
                return controller.isLoading
                    ...
                    : HomeCarouselSlider(sliderImages: controller.carouselImages);
              },
            ),
            SizedBox(height: 8),
            SectionHeader(
            ...
            SectionHeader(
              title: 'Popular',
              seeAll: () {
                Navigator.pushReplacementNamed(context, PopularListScreen.name);
              },
            ),
            ...
            : SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: CategoryItemWidget(category: controller.categoryList[index],),
                  );
                },
              ),
            );
